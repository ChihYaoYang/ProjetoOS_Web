<div class="container mt-3">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page">Lista de Status</li>
        </ol>
    </nav>
    <div class="row">
        <div class="col">
            <h3 class="card-header bg-transparent"><i class="fas fa-list-alt"></i> Lista de Status</h3>
            <?php
            //Mensagem
                    ...
                    <tbody>
                        ...
                        if (count($Status) > 0) {
                            foreach ($Status as $s) {
                                ...
                                echo '<td>' . $s->status . '</td>';
                                echo '<td class="text-right">' . '<a class="btn btn-sm btn-outline-danger mr-2 delete" href="' . base_url('Status/deletar/' . $s->id) . '"><i class="fas fa-trash-alt"></i> Delete</a>' .
                                    '<a class="btn btn-sm btn-outline-warning" href="' . base_url('Status/alterar/' . $s->id) . '"><i class="fas fa-edit"></i> Alterar</a>'
                                    . '</td>';
                                echo '</tr>';
                            }
                        } else {
                            echo '<tr><td colspan="2">Nenhum Status cadastrado</td></tr>';
                        }
                        ?>
                    </tbody>
                </table>
